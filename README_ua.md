...
Навігація стрілками або клавішами 1-6. `q` або `Esc` для повернення/виходу.
...
- **Reports** — перегляд попередніх результатів аналізу
- **Settings** — перегляд поточної конфігурації
- **Update** — перевірка нових версій

Навігація стрілками або гарячими клавішами (1-6). `q` або `Esc` для виходу.
