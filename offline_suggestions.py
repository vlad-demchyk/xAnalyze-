...
PHRASE_SUGGESTIONS: dict = {
    ...
    "uk": {
        ...
        # Доповнення до паритету з англійським списком (2026-08-20). None там,
        # де фраза є позиціюванням: чим її замінити, залежить від того, що
        # справді правда про продукт, а таблиця підстановок цього не знає.
        "варто зауважити": "", "слід зазначити": "",
        "важливо зазначити": "", "необхідно розуміти": "", "загалом кажучи": "", "певною мірою": "",
        "у сучасному цифровому": "", "у наш час": "", "в епоху": "",
        "сьогодні, коли": "", "у світі, що швидко змінюється": "",
        "дедалі більше": "", "підсумовуючи вищесказане": "",
        "у підсумку,": "", "одним словом,": "",
        "розберімося": "", "уявіть собі": "", "а що, якщо": "",
        "залишайтеся з нами": "", "давайте розглянемо": "",
        "давайте зануримось": "",
        "не шукайте далі": None, "вивільніть потенціал": "використайте сповна",
        "нові можливості": None, "справжня революція": None,
        "проривне рішення": "рішення", "на новий рівень": None,
        "гнучке рішення": "рішення", "запорука успіху": None,
        "ключ до успіху": None, "низка переваг": "переваги",
        "чимало переваг": "переваги", "широкий вибір": "вибір",
        "справлятися з будь-яким": None, "будь-яке завдання": None,
        "зосередитися на важливому": None, "зосередитись на головному": None,
        "щоб ви могли зосередитися": None, "плавніший досвід": None,
        "інтуїтивніший досвід": None, "бездоганний досвід": None,
        "єдиний робочий простір": None, "усе необхідне": None,
        "жодних складнощів": None, "без зайвих зусиль": None,
        "лише кілька кроків": None, "у два кліки": None,
        "за лічені хвилини": None, "заощаджуйте час": None,
        "економте час": None, "підвищте продуктивність": None,
        "зробіть більше за менший час": None, "створено для того, щоб": "щоб",
        "розроблено, щоб": "щоб", "просто працює": None,
        "довіряють тисячі": None, "тисячі команд": None,
        "надійна безпека": "безпека", "змінює те, як": "змінює, як",
        "змінити те, як": "змінити, як",
        "інноваційний": "новий", "трансформаційний": "",
        "безшовний": "", "масштабований": "", "проривний": "",
        "передовий": "", "неперевершений": "", "багатогранний": "різнобічний",
        "всеосяжний": "повний", "революціонізувати": "змінити",
        "максимізувати": "збільшити", "нівелювати": "усунути",
        "уможливлює": "дає змогу", "покликаний": "має",
        "вирізняється": "відрізняється", "гармонійно": "",
    },
    "it": {
        # product and interface copy. Most of these have no mechanical
        # replacement: they are positioning, and what replaces them depends
        ...
        # Aggiunte per la parità con la lista inglese (2026-08-20). None dove
        # la frase è posizionamento: cosa metterci dipende da ciò che è
        # davvero vero del prodotto, e una tabella di sostituzioni non lo sa.
        "va notato che": "", "occorre considerare": "",
        "in linea di massima": "", "in una certa misura": "",
        "nell'era digitale": "", "in un mondo in continua evoluzione": "",
        "ai giorni nostri": "", "sempre più spesso": "spesso",
        "per riassumere": "", "in sintesi": "", "in definitiva,": "",
        "scopriamo insieme": "", "immagina di": "", "e se ti dicessi": "",
        "resta con noi": "", "vediamo insieme": "",
        "non cercare oltre": None, "libera il potenziale": "sfrutta",
        "nuove possibilità": None, "una vera rivoluzione": None,
        "soluzione all'avanguardia": "soluzione",
        "porta a un nuovo livello": None, "la chiave del successo": None,
        "una serie di vantaggi": "vantaggi", "ampia scelta": "scelta",
        "qualunque sia il tuo": None, "concentrarti su ciò che conta": None,
        "così puoi concentrarti": None, "esperienza più fluida": None,
        "esperienza impeccabile": None, "un unico spazio di lavoro": None,
        "tutto ciò di cui hai bisogno": None, "senza alcuno sforzo": None,
        "in pochi passaggi": None, "in due clic": None,
        "in pochissimo tempo": None, "risparmia tempo": None,
        "aumenta la produttività": None, "fai di più in meno tempo": None,
        "progettato per": None, "funziona e basta": None,
        "scelto da migliaia": None, "migliaia di team": None,
        "sicurezza affidabile": "sicurezza", "cambia il modo in cui": None,
