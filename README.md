...
```bash
# Download and open
curl -L -o XAnalyze.dmg https://github.com/vlad-demchyk/xAnalyze-/releases/latest/download/XAnalyze.dmg
open XAnalyze.dmg
```
...
# Use
xanalyze fullscan https://example.com --json --report report.md
```
